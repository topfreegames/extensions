...
func (m *MockRedisClient) HScan(key string, cursor uint64, match string, count int64) *redis.ScanCmd {
	m.ctrl.T.Helper()
...
func (mr *MockRedisClientMockRecorder) HScan(key, cursor, match, count interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "HScan", reflect.TypeOf((*MockRedisClient)(nil).HScan), key, cursor, match, count)
}
